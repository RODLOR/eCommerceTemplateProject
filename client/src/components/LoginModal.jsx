...
function LoginModal() {
  ...
  return (
    <div className="flex items-center justify-center"         onMouseEnter={toggleModal} onMouseLeave={toggleModal}>
      <button
      ...
      {isOpen ? (
        <div className="fixed z-10 top-12 right-4 flex shadow-md">
                <div className="bg-gray-300 p-6 w-80 flex flex-col text-center">
                  ...
                  <form name="Login_form" action="/login" method="POST" className="flex flex-col gap-4">
