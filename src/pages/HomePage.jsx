...
const HomePage = () => {
  return (
    <section
      className="flex flex-col max-w-screen-xl mx-4 items-center place-self-center bg-gray-100 rounded-3xl mt-5"
    >
      <form className="max-w-xl w-full flex items-center pt-10 pb-10">
